...
import com.version1chat.kotlin7minutesworkout.databinding.ActivityExerciseBinding
import com.version1chat.kotlin7minutesworkout.databinding.ActivityMainBinding
import com.version1chat.kotlin7minutesworkout.databinding.DialogCutomBackConfirmationBinding
import java.util.*
...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    override fun onBackPressed() {
        customDialogForBackButton()
//        super.onBackPressed()   --> This is a predefined Back press method but we have already made
    //        back press with custom design so that's why we are using custom one
    }
    ...
    private fun setUpRestView(){
        ...
        try{
            val soundURI = Uri.parse("android.resource://com.version1chat.kotlin7minutesworkout/" + R.raw.press_start)
